...
generated quantities {
  ...
  real RG;
  real RU;
  Dep = (exp(beta[1] + beta[2]*.5) - exp(beta[1] - beta[2]*.5));
  AG = (exp(beta[1] + beta[3]*.5) - exp(beta[1] - beta[3]*.5));
  AU = (exp(beta[1] + beta[4]*.5) - exp(beta[1] - beta[4]*.5));
  RG = (exp(beta[1] + beta[5]*.5) - exp(beta[1] - beta[5]*.5));
  RU = (exp(beta[1] + beta[6]*.5) - exp(beta[1] - beta[6]*.5));
}
