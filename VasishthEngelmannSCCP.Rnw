...
% introduction
<<c01, child='c01sccp.Rnw'>>=
@

% main phenomena of interest
<<c02, child='c02sccp.Rnw'>>=
@

% core model
<<c03, child='c03sccp.Rnw'>>=
@

% prominence
<<c04, child='c04sccp.Rnw'>>=
@
...
\bibliography{sccp,EMMA-edited,cuesim}\label{refs}
