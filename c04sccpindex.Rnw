...
\begin{figure}[!htbp]
\centering
<<prominenceNew, include=TRUE, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, Figurewidth=6,Figureheight=3.5, out.width='.8\\textwidth'>>=
...
<<cueconf, eval=FALSE,include=TRUE, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, Figurewidth=6,Figureheight=3.5, out.width='.8\\textwidth'>>=
...
\begin{figure}[htbp]
\centering
<<datsumfig, include=TRUE, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, Figurewidth=8,Figureheight=3, out.width='\\textwidth'>>=
...
<<simresults, eval=FALSE,include=TRUE, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, Figurewidth=8,Figureheight=5, out.width='\\textwidth'>>=
...
<<simresultsSlct, eval=FALSE,include=TRUE, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, Figurewidth=8,Figureheight=4, out.width='0.9\\textwidth'>>=
