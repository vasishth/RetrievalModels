...
%cite De Bleser, Cholewa, Stadies, Tabatable 1997.
...
% summarize the various attempts, in table?
...
\citep{NicenboimRetrieval2017,JaegerEngelmannVasishth2017,EngelmannJaegerVasishthSubmitted2016} and the interaction between oculomotor control and sentence comprehension \citep{Engelmanna}.\footnote{The model can be downloaded in its current form from 
...
\section{Mapping ACT-R parameters to sources of deficits}
