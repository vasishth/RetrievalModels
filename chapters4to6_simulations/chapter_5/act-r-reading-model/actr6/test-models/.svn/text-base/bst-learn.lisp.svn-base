...
(defun build-display (a b c target)
   ...
   (add-line-to-exp-window (list 75 35)  (list (+ a 75) 35) 'black)
   (add-line-to-exp-window (list 75 60)  (list (+ b 75) 60) 'black)
   (add-line-to-exp-window (list 75 85)  (list (+ c 75) 85) 'black)
   (add-line-to-exp-window (list 75 110) (list (+ target 75) 110) 'green)
...
(defun update-current-line ()
   ...
   (if (= *current-stick* *target*)
       (progn
         (setf *done* t) 
         (setf *current-line* (add-line-to-exp-window (list 75 135) (list  (+ *target* 75) 135) 'blue))
         (add-text-to-exp-window :x 180 :y 200 :width 50 :text "Done"))
     (if (zerop *current-stick*)
           (setf *current-line* nil)
         (setf *current-line* (add-line-to-exp-window (list 75 135) (list (+ *current-stick* 75) 135) 'blue))))
...
(sgp :model-warnings nil
     :v nil :esc t :egs 3 :show-focus t :trace-detail medium :ul t :ncnar nil :ult t)
