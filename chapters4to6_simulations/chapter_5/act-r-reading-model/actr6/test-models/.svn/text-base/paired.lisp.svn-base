...
(defvar *act-trace* nil)
(defvar *compilation* nil)

(defun run-it ()
  (setf *act-trace* t *compilation* nil)
  (do-experiment 1 2)
  (sdm isa pair)
  (setf *act-trace* nil *compilation* t)
  (do-experiment 1 2)
  (setf *act-trace* nil *compilation* nil)
  (do-experiment 2 2)
...
(define-model paired
  ...
  (sgp :save-buffer-trace t :traced-buffers (goal visual visual-location imaginal retrieval manual))
(sgp :seed (200 4))
(sgp-fct (List :v *out-file* :cmdt *out-file* :act *act-trace* :epl *compilation* :pct *compilation*))
