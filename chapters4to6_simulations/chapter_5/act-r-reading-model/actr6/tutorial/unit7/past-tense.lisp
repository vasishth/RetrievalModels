...
(defun graph-it (data)
  (let ((win (open-exp-window "Irregular Verbs correct" :width 400 :height 350)))
    ...
    (add-line-to-exp-window '(30 10) '(30 310) 'black)
    (add-line-to-exp-window '(380 310) '(30 310) 'black)
    (add-line-to-exp-window '(25 10) '(35 10) 'black)
    (add-line-to-exp-window '(25 110) '(35 110) 'black)
    (add-line-to-exp-window '(25 210) '(35 210) 'black)
